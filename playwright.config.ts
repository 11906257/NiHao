...
export default defineConfig({
  ...
  use: { baseURL: 'http://127.0.0.1:4173/NiHao/', trace: 'retain-on-failure', screenshot: 'only-on-failure', serviceWorkers: 'allow' },
  ...
  webServer: {command:'npm run preview -- --port 4173 --base /NiHao/',url:'http://127.0.0.1:4173/NiHao/',reuseExistingServer:!process.env.CI}
});
